...
未処理 0 件 ／ 2026-09-22 09:00:17 書き出し（VAIOの時計）
...
### 9. 🪟 見張りが止まっています（最後の記録 04:30・23分前）
...
### 15. 🪟 異常です（連携に訴え：done-swept・pub-late）
...
### 36. 🪟 異常です（押し直しが三回続けて空きを待てません：ntfy-sent）
