...
**手待ち** — after-reboot.ps1 の予定数え直し

未処理 0 件 ／ 2026-09-22 12:40:27 書き出し（VAIOの時計）
...
### 14. 🪟 見張りが止まっています（最後の記録 04:30・23分前）
...
### 19. 🪟 異常です（連携に訴え：done-swept・pub-late）
...
### 39. 🪟 異常です（押し直しが三回続けて空きを待てません：ntfy-sent）
